...
# Project labels
test_project_labels_unknown_allowed {
    no_violations 
    with input as { "resource_changes": [{ "type": "google_project", "change": { "after": { "name": "Test project" }, "after_unknown": { "labels": {} } } }] }
}
...
test_missing_env_label_denied {
    ...
    with input as { "resource_changes": [{ "type": "google_project", "change": { "after": { "name": "Test project", "labels": { "team": "whatevs" } } } }] }
}
